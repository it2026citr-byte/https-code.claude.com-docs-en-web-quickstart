...
// --- список монет ---------------------------------------------------------
// Экспортированы: /coins в commands.js собирает ту же строку статистики.
export const sig = (n) => `${n} ${plural(n, ["сигнал", "сигнала", "сигналов"])}`;
export const prof = (n) => `${n} ${plural(n, ["прибыльный", "прибыльных", "прибыльных"])}`;
